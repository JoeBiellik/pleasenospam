...
Simple [Node.js](https://nodejs.org/) temporary email service built with [Koa](http://koajs.com/), [RethinkDB](https://www.rethinkdb.com/), [smtp-server](https://www.npmjs.com/package/smtp-server), [Pug](https://pugjs.org/), [Bootstrap 4](http://v4-alpha.getbootstrap.com/) and [Handlebars.js](http://handlebarsjs.com/).
